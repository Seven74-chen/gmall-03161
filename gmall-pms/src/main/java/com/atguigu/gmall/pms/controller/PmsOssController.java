...
public class PmsOssController {
    String accessId = "LTAI4GF3iW1mHXzHy8px6BNv"; // 请填写您的AccessKeyId。
    String accessKey = "r5S5YMBv1EmQcA7CkYlAw38G1qexFj"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "guli-200316"; // 请填写您的 bucketname 。
